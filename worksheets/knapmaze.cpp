...
bool find_path(vector<vector<int>> &maze, int x, int y, int dest_x, int dest_y, vector<pair<int, int>> &path) {
...
int main() {
    ...
    bool found = find_path(maze, start_x, start_y, dest_x, dest_y, path);
